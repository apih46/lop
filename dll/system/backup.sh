...
LLatest=`date`
Get_Data () {
git clone https://github.com/akuhaa021/user-backup-db.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git remote add origin https://github.com/akuhaa021/user-backup-db
    git push -f https://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@github.com/akuhaa021/user-backup-db.git &> /dev/null
}
